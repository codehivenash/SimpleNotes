...
class NotebooksControllerTest < ActionController::TestCase
  ...
  test "should create notebook" do
    assert_difference('Notebook.count') do
      post :create, notebook: { description: @notebook.description, name: @notebook.name, owner: @notebook.owner }
    end
  ...
  test "should update notebook" do
    patch :update, id: @notebook, notebook: { description: @notebook.description, name: @notebook.name, owner: @notebook.owner }
    assert_redirected_to notebook_path(assigns(:notebook))
  end
